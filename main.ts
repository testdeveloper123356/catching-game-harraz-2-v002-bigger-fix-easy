...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite2, otherSprite2) {
    sprites.destroy(otherSprite2, effects.disintegrate, 5000)
    info.changeLifeBy(-1)
...
info.setLife(99999999999)
info.setScore(0)
info.startCountdown(128)
game.onUpdateInterval(5000, function () {
    ...
    mySprite3.setVelocity(randint(80, -600), randint(-600, 80))
...
game.onUpdateInterval(100, function () {
    ...
    mySprite2.setVelocity(randint(100, -600), randint(-600, 100))
})
game.onUpdateInterval(100, function () {
    ...
    mySprite4.setVelocity(randint(100, -600), randint(-600, 100))
})
